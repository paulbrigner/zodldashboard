...
#   X_API_ARTICLE_CAPTURE_ENABLED=true
...
#   X_API_BASE_TERMS='Zcash OR ZEC OR Zodl'
...
X_API_ARTICLE_CAPTURE_ENABLED="${X_API_ARTICLE_CAPTURE_ENABLED:-true}"
...
X_API_BASE_TERMS="${X_API_BASE_TERMS:-Zcash OR ZEC OR Zodl}"
...
SUMMARY_TOP_POSTS_7D="${SUMMARY_TOP_POSTS_7D:-12}"
...
SUMMARY_LLM_MODEL="${SUMMARY_LLM_MODEL:-openai-gpt-56-terra}"
SUMMARY_LLM_API_KEY="${SUMMARY_LLM_API_KEY:-}"
SUMMARY_LLM_TEMPERATURE="${SUMMARY_LLM_TEMPERATURE:-1}"
SUMMARY_LLM_MAX_TOKENS="${SUMMARY_LLM_MAX_TOKENS:-900}"
SUMMARY_LLM_TIMEOUT_MS="${SUMMARY_LLM_TIMEOUT_MS:-180000}"
...
ENV_JSON="$(
  ...
  X_API_ARTICLE_CAPTURE_ENABLED="$X_API_ARTICLE_CAPTURE_ENABLED" \
  ...
  SUMMARY_TOP_POSTS_7D="$SUMMARY_TOP_POSTS_7D" \
...
print(json.dumps({
  "Variables": {
    ...
    "XMON_X_API_ARTICLE_CAPTURE_ENABLED": os.environ["X_API_ARTICLE_CAPTURE_ENABLED"],
    ...
    "XMON_SUMMARY_TOP_POSTS_7D": os.environ["SUMMARY_TOP_POSTS_7D"],
