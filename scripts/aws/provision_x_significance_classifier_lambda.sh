...
#   SIGNIFICANCE_LLM_MODEL=zai-org-glm-4.7-flash
...
SIGNIFICANCE_LLM_MODEL="${SIGNIFICANCE_LLM_MODEL:-zai-org-glm-4.7-flash}"
...
SIGNIFICANCE_LLM_MAX_ATTEMPTS="${SIGNIFICANCE_LLM_MAX_ATTEMPTS:-1}"
...
SIGNIFICANCE_BATCH_SIZE="${SIGNIFICANCE_BATCH_SIZE:-1}"
...
SIGNIFICANCE_VERSION="${SIGNIFICANCE_VERSION:-ai_v2}"
