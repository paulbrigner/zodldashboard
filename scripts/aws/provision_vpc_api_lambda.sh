...
#   COMPOSE_DEFAULT_RETRIEVAL_LIMIT=150
#   COMPOSE_MAX_RETRIEVAL_LIMIT=150
#   COMPOSE_DEFAULT_CONTEXT_LIMIT=32
#   COMPOSE_MAX_CONTEXT_LIMIT=32
...
#   GUEST_MAGIC_LINK_ENABLED=false
#   GUEST_MAGIC_LINK_FROM_ADDRESS=alerts@zodldashboard.com
#   GUEST_MAGIC_LINK_FROM_NAME="ZODL Dashboard"
#   EMAIL_SCHEMA_BOOTSTRAP=true
#   DB_MIGRATIONS_BOOTSTRAP=false
#   DB_MIGRATIONS_FROM_FILE=007_remove_legacy_post_tracking.sql
#   USER_PROXY_SECRET=...
#   ACCESS_BOOTSTRAP_ADMIN_EMAILS=paul@zodl.com
#   ALLOWED_GUEST_GOOGLE_EMAILS=guest@example.com
#   ALLOWED_ROADMAP_GUEST_EMAILS=roadmap@example.com
#   ALLOWED_ARKTOUROS_GUEST_EMAILS=arktouros@example.com
#   SUMMARY_SCHEMA_BOOTSTRAP=true
#   SUMMARY_SCHEMA_GRANT_ROLE=xmonitor_app
#   QUERY_STATE_SCHEMA_BOOTSTRAP=false
...
COMPOSE_DEFAULT_RETRIEVAL_LIMIT="${COMPOSE_DEFAULT_RETRIEVAL_LIMIT:-150}"
COMPOSE_MAX_RETRIEVAL_LIMIT="${COMPOSE_MAX_RETRIEVAL_LIMIT:-150}"
COMPOSE_DEFAULT_CONTEXT_LIMIT="${COMPOSE_DEFAULT_CONTEXT_LIMIT:-32}"
COMPOSE_MAX_CONTEXT_LIMIT="${COMPOSE_MAX_CONTEXT_LIMIT:-32}"
...
COMPOSE_MODEL="${COMPOSE_MODEL:-openai-gpt-55}"
...
GUEST_MAGIC_LINK_ENABLED="${GUEST_MAGIC_LINK_ENABLED:-}"
GUEST_MAGIC_LINK_FROM_ADDRESS="${GUEST_MAGIC_LINK_FROM_ADDRESS:-}"
GUEST_MAGIC_LINK_FROM_NAME="${GUEST_MAGIC_LINK_FROM_NAME:-ZODL Dashboard}"
...
ACCESS_BOOTSTRAP_ADMIN_EMAILS="${ACCESS_BOOTSTRAP_ADMIN_EMAILS:-}"
ALLOWED_GUEST_GOOGLE_EMAILS="${ALLOWED_GUEST_GOOGLE_EMAILS:-}"
ALLOWED_ROADMAP_GUEST_EMAILS="${ALLOWED_ROADMAP_GUEST_EMAILS:-}"
ALLOWED_ARKTOUROS_GUEST_EMAILS="${ALLOWED_ARKTOUROS_GUEST_EMAILS:-}"
...
if [[ -z "$GUEST_MAGIC_LINK_ENABLED" ]]; then
  GUEST_MAGIC_LINK_ENABLED="$(existing_lambda_var "GUEST_MAGIC_LINK_ENABLED")"
fi
if [[ -z "$GUEST_MAGIC_LINK_FROM_ADDRESS" ]]; then
  GUEST_MAGIC_LINK_FROM_ADDRESS="$(existing_lambda_var "GUEST_MAGIC_LINK_FROM_ADDRESS")"
fi
if [[ -z "$USER_PROXY_SECRET" ]]; then
  USER_PROXY_SECRET="$(existing_lambda_var "XMONITOR_USER_PROXY_SECRET")"
fi
if [[ -z "$ACCESS_BOOTSTRAP_ADMIN_EMAILS" ]]; then
  ACCESS_BOOTSTRAP_ADMIN_EMAILS="$(existing_lambda_var "ACCESS_BOOTSTRAP_ADMIN_EMAILS")"
fi
if [[ -z "$ALLOWED_GUEST_GOOGLE_EMAILS" ]]; then
  ALLOWED_GUEST_GOOGLE_EMAILS="$(existing_lambda_var "ALLOWED_GUEST_GOOGLE_EMAILS")"
fi
if [[ -z "$ALLOWED_ROADMAP_GUEST_EMAILS" ]]; then
  ALLOWED_ROADMAP_GUEST_EMAILS="$(existing_lambda_var "ALLOWED_ROADMAP_GUEST_EMAILS")"
fi
if [[ -z "$ALLOWED_ARKTOUROS_GUEST_EMAILS" ]]; then
  ALLOWED_ARKTOUROS_GUEST_EMAILS="$(existing_lambda_var "ALLOWED_ARKTOUROS_GUEST_EMAILS")"
fi
if [[ -z "$EMAIL_ENABLED" ]]; then
  EMAIL_ENABLED="false"
fi
...
ENV_JSON="$(
  ...
  QUERY_STATE_SCHEMA_BOOTSTRAP="$QUERY_STATE_SCHEMA_BOOTSTRAP" \
  python3 - <<'PY'
import json, os
print(json.dumps({
  "Variables": {
    ...
    "GUEST_MAGIC_LINK_ENABLED": os.environ.get("GUEST_MAGIC_LINK_ENABLED", ""),
    "GUEST_MAGIC_LINK_FROM_ADDRESS": os.environ.get("GUEST_MAGIC_LINK_FROM_ADDRESS", ""),
    "GUEST_MAGIC_LINK_FROM_NAME": os.environ.get("GUEST_MAGIC_LINK_FROM_NAME", ""),
    ...
    "XMONITOR_DB_MIGRATIONS_FROM_FILE": os.environ.get("DB_MIGRATIONS_FROM_FILE", ""),
    "XMONITOR_USER_PROXY_SECRET": os.environ.get("USER_PROXY_SECRET", ""),
    "ACCESS_BOOTSTRAP_ADMIN_EMAILS": os.environ.get("ACCESS_BOOTSTRAP_ADMIN_EMAILS", ""),
    "ALLOWED_GUEST_GOOGLE_EMAILS": os.environ.get("ALLOWED_GUEST_GOOGLE_EMAILS", ""),
    "ALLOWED_ROADMAP_GUEST_EMAILS": os.environ.get("ALLOWED_ROADMAP_GUEST_EMAILS", ""),
    "ALLOWED_ARKTOUROS_GUEST_EMAILS": os.environ.get("ALLOWED_ARKTOUROS_GUEST_EMAILS", ""),
    ...
    "XMONITOR_ENABLE_QUERY_STATE_SCHEMA_BOOTSTRAP": os.environ.get("QUERY_STATE_SCHEMA_BOOTSTRAP", ""),
