...
#   COMPOSE_MODEL=openai-gpt-56-terra-pro
...
#   NEXTAUTH_URL=https://www.zodldashboard.com
...
COMPOSE_MODEL="${COMPOSE_MODEL:-openai-gpt-56-terra-pro}"
...
NEXTAUTH_URL="${NEXTAUTH_URL:-https://www.zodldashboard.com}"
...
ENV_JSON="$(
  ...
  GUEST_MAGIC_LINK_ENABLED="$GUEST_MAGIC_LINK_ENABLED" \
  GUEST_MAGIC_LINK_FROM_ADDRESS="$GUEST_MAGIC_LINK_FROM_ADDRESS" \
  GUEST_MAGIC_LINK_FROM_NAME="$GUEST_MAGIC_LINK_FROM_NAME" \
